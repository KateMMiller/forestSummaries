...
cap_t3 <- paste0("<p style='font-size:10px; padding:0 5px;'><b>Table 3.</b> Number of plots out of ", num_plots, " where priority invasive species were detected. ", paste0(cycle_labs, collapse = "; "), ". Species on the list include all exotic vascular plant species that are capable of dominating Eastern US forest habitats, and does not include all exotic species detected in MIDN forest plots. ", "</p>")
...
tab3 <- 
  ...
  tab3 <- HTML("<p>   No priority invasive species observed in cycle 1. </p>")  
...
```{r results = 'asis'}
cat(paste0("<p><b>Figure 3.</b> Ungulate browse impacts in cycle 1 in ", park_long, " (", park, "). Note that this index does not distinguish deer from horse browse in ", park, ". ",
    paste(cycle_labs, collapse = "; "), ". ", 
    sep = ""))
...
```{r out.width = "98%"}
include_graphics(paste0(new_path, "figures/Figure_4_", park, "_tree_sapling_regen_by_species.svg"))
```
