...
QAQC <<- FALSE
locType <<- 'VS'
#panel_4yr_start <<- as.numeric(midn_params$panel_4yr[midn_params$park == park])
...
|       A. 
```{r out.width = "92%", out.extra = 'style="margin-top:-60px;margin-left:20px;margin-bottom:-60px"'}
include_graphics(paste0(new_path, "figures/Figure_1A_", park, "_regen_by_size_class_by_cycle.svg"))
```

|       B. 
```{r out.width = "92%", out.extra = 'style="margin-top:-45px;margin-left:20px;margin-bottom:-50px"'}
...
```
<br>
```{r out.width = "45%", out.extra = 'style="margin-left:130px; margin-top:-100px;margin-bottom:-100px;"'}
...
```{r out.width = "80%", out.extra = 'style="margin-left:100px;margin-top:-150px;margin-bottom:-30px;"'}
