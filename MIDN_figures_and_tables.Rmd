...
```{r include = F, eval = T, results = 'hide'}
# Table 3 setup
tab3_cols <- c("Latin Name", "Common Name", "Invasive", gsub("cycle_", "Cycle ", 
                                                 names(inv_spp_final[,4:ncol(inv_spp_final)])))
...
include_graphics(paste0(new_path, "figures/Figure_1_Regen_Debt_table.svg"))
```
