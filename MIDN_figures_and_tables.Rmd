...
park <<- park #For running 'generate_all_MIDN_reports.R'
# park <<- "BOWA" #for running indiv. parks
path <<- 'C:/01_NETN/Forest_Health/Data_Summaries/2024 Data Summaries/MIDN/' #ces path
