...
|       A. 
```{r out.width = "92%", out.extra = 'style="margin-top:-60px;margin-left:20px;margin-bottom:-30px"'}
include_graphics(paste0(new_path, "figures/Figure_1A_", park, "_regen_by_size_class_by_cycle.svg"))
```
|       B. 
```{r out.width = "92%", out.extra = 'style="margin-top:-60px;margin-left:20px;margin-bottom:-50px"'}
...
```{r out.width = "80%", out.extra = 'style="margin-left:100px;margin-top:-60px;margin-bottom:-30px;"'}
