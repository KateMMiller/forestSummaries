...
path <<- paste0('./output/', report_year, "/NETN/")#'C:/01_NETN/Forest_Health/Data_Summaries/2024 Data Summaries/NETN/' #ces path
...
```{r include = F, eval = T, results = 'hide'}
# Table 3 setup
tab3_cols <- if(park == "MORR"){c("Latin Name", "Common Name", 
