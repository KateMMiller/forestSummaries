...
Betula <- c('Betula',#'Betula alleghaniensis', 
...
Picea <- c("Picea", "Picea rubens", "Picea mariana", "Picea glauca")
...
Other_Hardwood <- c('Amelanchier', 'Acer saccharum')
Other_Conifer <- c("Larix laricina", "Thuja occidentalis", "Tsuga canadensis")
...
reg_all <- reg_all %>% 
    mutate(spp_grp = case_when(ScientificName %in% Betula ~ "BETSPP",
                               ...
                               ScientificName %in% Picea ~ "PICSPP",
                               ScientificName %in% Pinus ~ "PINSPP",
                               ScientificName %in% Populus ~ "POPSPP",
                               ScientificName %in% Subcanopy ~ "SUBCAN",
                               ScientificName %in% Other_Hardwood ~ "OTHHAR",
                               ScientificName %in% Other_Conifer ~ "OTHCON",
                               TRUE ~ toupper(paste0(
