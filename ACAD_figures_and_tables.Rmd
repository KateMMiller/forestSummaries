...
cap_t3 <- 
  ...
  if(report_year < 2029){paste0("Note that only ", num_samp, " out of ", num_plots, " have been sampled in cycle ", cycle_latest,  ".")},        
         "</p>")
...
tab1_kab <- function(park, row_start = 1, row_end = num_plots, table_name = "table1"){
  ...
  kable(df, col.names = tab1_row2, digits = 2, align = 'c', format = 'html', 
        table.attr = "style='width:90%;height:95%;'", row.names = F) %>% #, caption = cap_t1) %>%
